...
class _AssignmentsScreenState extends State<AssignmentsScreen> {
  ...
  void initState() {
    ...
    _items = List<Map<String, dynamic>>.from(
      AssignmentsMockData.assignmentItems,
    );
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 3,
                  child: Text('ASSIGNED TEACHER', style: _headerStyle()),
                ),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            '${_filteredItems.length} Assignments',
            style: GoogleFonts.figtree(
              fontSize: 14,
              fontWeight: FontWeight.bold,
              color: _textDark,
...
class _AssignmentViewDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final notSubmitted = List.generate(
      notSubmittedCount,
      (i) => ({
        'name': [
          'Diya Khan',

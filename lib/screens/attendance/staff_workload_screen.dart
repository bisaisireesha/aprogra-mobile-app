...
class _StaffWorkloadScreenState extends State<StaffWorkloadScreen> {
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text('Assign Workload', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
            ],
          ),
        ),
      ],
      ...
      builder: (context, constraints) {
        return GridView.count(
          ...
          children: [
            ...
            _buildKpiCard('6', 'Overloaded Teachers', LucideIcons.alertTriangle, const Color(0xFFEF4444), const Color(0xFFFEE2E2)),
            _buildKpiCard('5', 'Under-utilized', LucideIcons.trendingDown, const Color(0xFFF59E0B), const Color(0xFFFEF3C7)),
          ],
        );
      },
    );
          ...
          children: [
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('All Departments', style: GoogleFonts.figtree(fontSize: 14, color: _textDark, fontWeight: FontWeight.w500)),
                  const SizedBox(width: 8),
            ...
            Container(
              ...
              child: const Icon(LucideIcons.arrowDownUp, size: 16, color: _textDark),
            ),
          ],
        ),
      ],
  ...
  Widget _buildWorkloadList() {
    return Column(
      children: _workloads.map((workload) => _buildWorkloadCard(workload)).toList(),
    );
  }
  ...
  Widget _buildWorkloadCard(Map<String, dynamic> workload) {
    ...
    if (workload['name'] == 'Priya Sharma') {
      ...
      avatarBgColor = const Color(0xFFE0F2FE); avatarTextColor = const Color(0xFF0284C7);
      ...
      avatarBgColor = const Color(0xFFDCFCE7); avatarTextColor = const Color(0xFF16A34A);
    } else {
      avatarBgColor = const Color(0xFFFEF3C7); avatarTextColor = const Color(0xFFF59E0B);
    }

    return GestureDetector(
      onTap: () => _showWorkloadDetails(context, workload, progressColor, statusColor, statusBgColor, avatarBgColor, avatarTextColor),
      child: Container(
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            child: Text(workload['initials'], style: GoogleFonts.figtree(fontSize: 16, fontWeight: FontWeight.bold, color: avatarTextColor)),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(workload['name'], style: GoogleFonts.figtree(fontSize: 16, fontWeight: FontWeight.bold, color: _textDark)),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text('${(workload['utilization'] * 100).toInt()}%', style: GoogleFonts.figtree(fontSize: 16, fontWeight: FontWeight.bold, color: progressColor)),
                        ...
                        SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              value: (workload['utilization'] > 1.0) ? 1.0 : workload['utilization'],
                ...
                const SizedBox(height: 4),
                Text(workload['department'], style: GoogleFonts.figtree(fontSize: 13, color: _textMuted)),
                const SizedBox(height: 12),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: (workload['subjects'] as List<String>).map((subject) => Container(
                ...
                Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Classes', style: GoogleFonts.figtree(fontSize: 11, color: _textMuted)),
                        const SizedBox(height: 2),
                        Text(workload['classes'], style: GoogleFonts.figtree(fontSize: 13, fontWeight: FontWeight.w600, color: _textDark)),
                      ],
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text('Periods/Wk', style: GoogleFonts.figtree(fontSize: 11, color: _textMuted)),
                        const SizedBox(height: 2),
                        Text('${workload['periods']}', style: GoogleFonts.figtree(fontSize: 13, fontWeight: FontWeight.w600, color: _textDark)),
                      ],
                    ),
                    Container(
                      ...
                      child: Text(workload['status'], style: GoogleFonts.figtree(fontSize: 12, fontWeight: FontWeight.bold, color: statusColor)),
                    ),
                  ],
                ),
              ],
...
void _showWorkloadDetails(
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 22,
                      backgroundColor: avatarBgColor,
                      child: Text(workload['initials'], style: GoogleFonts.figtree(fontSize: 15, fontWeight: FontWeight.bold, color: avatarTextColor)),
                    ),
                ...
                _buildWorkloadPopupRow(
                  ...
                  Wrap(
                    ...
                    children: (workload['subjects'] as List<String>).map((subject) => Container(
                      ...
                      child: Text(subject, style: GoogleFonts.figtree(fontSize: 12, color: const Color(0xFF4B5563), fontWeight: FontWeight.w500)),
                    )).toList(),
                  ),
                ),
                const SizedBox(height: 16),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(workload['status'], style: GoogleFonts.figtree(fontSize: 11, fontWeight: FontWeight.bold, color: statusColor)),
                      ),
                    ],
                  ),
                  alignTop: true,
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('View Profile', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: _accent)),
                          ),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('Adjust Workload', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                          ),
                        ),
                      ),
                    ),
  ...
  Widget _buildWorkloadPopupRow(String label, Widget valueWidget, {bool alignTop = false}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget _buildMostLoadedTeachersCard() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Most Loaded Teachers', style: GoogleFonts.figtree(fontSize: 16, fontWeight: FontWeight.bold, color: _textDark)),
          const SizedBox(height: 4),
  ...
  Widget _buildMostLoadedTeacherItem(String name, String department, double utilization) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          ...
          children: [
            ...
            Text('${(utilization * 100).toInt()}%', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: const Color(0xFFF43F5E))),
          ],
        ),
        const SizedBox(height: 8),
        ClipRRect(

  ...
  final List<Map<String, dynamic>> _defaulters = [
    {
      ...
      'avatarBg': const Color(0xFFEEEDFD),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Track pending dues, overdue invoices, and defaulters; follow up instantly.',
              ...
              child: _kpiCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const DefaultersListScreen(),
                    ),
                  );
                },
              ),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              'Breakdown of overdue amounts by age',
              style: GoogleFonts.figtree(fontSize: 12, color: _muted),
            ),
          ],
        ),
  ...
  Widget _buildBucketCard(Map<String, dynamic> b) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const DefaultersListScreen()),
        );
      },
      child: Container(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _bucketStat(b['amount'] as String, 'amount'),
                      ),
                      Container(
                        width: 1,
                        height: 30,
              ...
              child: Stack(
                children: [
                  ...
                  FractionallySizedBox(
                    widthFactor:
                        double.parse(
                          (b['percent'] as String).replaceAll('%', ''),
                        ) /
                        100.0,
                    child: Container(
                      height: 4,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Amounts are based on overdue invoices.',
              ...
              Expanded(
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Calling ${d['parent']}...')),
                      );
                    },
                ...
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Notification sent to ${d['parent']}!'),
                        ),
                      );
                    },
                    borderRadius: const BorderRadius.only(

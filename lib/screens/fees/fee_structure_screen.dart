...
class _FeeStructureScreenState extends State<FeeStructureScreen> {
  ...
  List<Map<String, dynamic>> _classDataList = [
    {
      'name': 'Class 5',
      'subtitle': 'Section A-C · 96 students',
      't1': '₹11,700',
      't2': '₹11,700',
      't3': '₹12,000',
      'annual': '₹35,400',
    ...
    {
      'name': 'Class 6',
      'subtitle': 'Section A-C · 102 students',
      't1': '₹12,400',
      't2': '₹12,400',
      't3': '₹12,700',
      'annual': '₹37,500',
    ...
    {
      'name': 'Class 7',
      'subtitle': 'Section A-C · 98 students',
      't1': '₹13,500',
      't2': '₹13,500',
      't3': '₹13,800',
      'annual': '₹40,800',
    ...
    {
      'name': 'Class 8',
      'subtitle': 'Section A-B · 84 students',
      't1': '₹14,300',
      't2': '₹14,300',
      't3': '₹14,700',
      'annual': '₹43,300',
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ClassFeeDetailsScreen(classData: cls),
              ),
            );
          },
          child: Container(

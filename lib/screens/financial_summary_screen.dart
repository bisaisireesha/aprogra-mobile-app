...
class _FinancialSummaryScreenState extends State<FinancialSummaryScreen> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSectionTitle('Outstanding Dues', 'Students with pending fee', LucideIcons.search),
                        const SizedBox(height: 24),
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(LucideIcons.calendarDays, size: 16, color: Color(0xFF6366F1)),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(flex: 2, child: Text('Due Date', style: _tableHeaderStyle())),
                Expanded(flex: 2, child: Text('Action', style: _tableHeaderStyle(), textAlign: TextAlign.right)),
              ],
            ),
          ),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Rohan Verma', '10-A', '₹12,420', '07 Days', const Color(0xFFF59E0B)),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Anaya Singh', '11-B', '₹9,870', '10 Days', const Color(0xFFF59E0B)),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Ishaan Patel', '12-C', '₹7,230', '12 Days', const Color(0xFFF59E0B)),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Neha Nair', 'X-A', '₹4,520', '02 Days', const Color(0xFFEF4444)),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Aditya Reddy', '11-A', '₹3,560', '5 Days', const Color(0xFF10B981)),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildDueRow('Priya Gupta', '9-A', '₹2,870', '7 Days', const Color(0xFF10B981)),
        ],
      ),
    );
  }
  ...
  Widget _buildDueRow(String student, String cls, String amount, String due, Color dueColor) {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Text(
                  due,
                  style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w600, color: dueColor),
                ),
              ),
            ),
          ),
          Expanded(
            ...
            child: Align(
              ...
              child: Text(
                'Remind',
                style: GoogleFonts.figtree(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF6366F1)),
              ),
            ),
          ),
        ],
        ...
        children: [
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Payment Mode Breakdown', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: _textDark)),
                Text('Total ₹40.80L', style: GoogleFonts.figtree(fontSize: 12, color: _textMuted)),
              ],
            ),
          ),
          Padding(
            ...
            child: Column(
              children: [
                _buildModeBar('Online', '₹24.52L', '(60%)', 0.60, const Color(0xFF6366F1)),
                const SizedBox(height: 16),
                _buildModeBar('Cash', '₹11.10L', '(27%)', 0.27, const Color(0xFF3B82F6)),
                const SizedBox(height: 16),
                _buildModeBar('Bank Transfer', '₹3.28L', '(8%)', 0.08, const Color(0xFF10B981)),
                const SizedBox(height: 16),
                _buildModeBar('Card', '₹1.64L', '(4%)', 0.04, const Color(0xFFF59E0B)),
                const SizedBox(height: 16),
                _buildModeBar('UPI', '₹0.26L', '(1%)', 0.01, const Color(0xFFEF4444)),
              ],
            ),
          ),
          const SizedBox(height: 24),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('View all', style: GoogleFonts.figtree(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF6366F1))),
              ],
            ),
          ),
          Padding(
          ...
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildPaymentRow('Rohan Verma', '10-A', 'Online', '₹12,420', 'Nov 24'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildPaymentRow('Anaya Singh', '11-B', 'Card', '₹9,870', 'Nov 24'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildPaymentRow('Ishaan Patel', '12-C', 'Online', '₹7,230', 'Nov 23'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
  ...
  Widget _buildModeBar(String label, String amount, String percentStr, double percent, Color color) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(label, style: GoogleFonts.figtree(fontSize: 13, fontWeight: FontWeight.bold, color: _textDark)),
            Row(
              children: [
                Text(amount, style: GoogleFonts.figtree(fontSize: 13, fontWeight: FontWeight.bold, color: _textDark)),
                const SizedBox(width: 4),
                Text(percentStr, style: GoogleFonts.figtree(fontSize: 12, color: _textMuted)),
              ],
            ),
          ],
        ),
  ...
  Widget _buildPaymentRow(String student, String cls, String mode, String amount, String date) {
    Color modeColor;
    switch (mode) {
      case 'Online': modeColor = const Color(0xFF6366F1); break;
      case 'Card': modeColor = const Color(0xFFF59E0B); break;
      case 'UPI': modeColor = const Color(0xFFEF4444); break;
      case 'Cash': modeColor = const Color(0xFF3B82F6); break;
      default: modeColor = _textMuted;
    }
          ...
          Expanded(
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Text(
                  mode,
                  style: GoogleFonts.inter(fontSize: 9, fontWeight: FontWeight.bold, color: modeColor),
                ),
              ),
            ),
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(20),
            child: Text('Ages of Dues', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: _textDark)),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Column(
              children: [
                _buildModeBar('0-30 Days', '₹0.58L', '(40%)', 0.40, const Color(0xFF10B981)),
                const SizedBox(height: 16),
                _buildModeBar('31-60 Days', '₹0.81L', '(42%)', 0.42, const Color(0xFFF59E0B)),
                const SizedBox(height: 16),
                _buildModeBar('60+ Days', '₹0.25L', '(18%)', 0.18, const Color(0xFFEF4444)),
              ],
            ),
          ),
          const SizedBox(height: 24),
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Daily Collection Trend (Last 7 Days)', style: GoogleFonts.figtree(fontSize: 14, fontWeight: FontWeight.bold, color: _textDark)),
                const SizedBox(height: 4),
                Text('Total ₹8.32L', style: GoogleFonts.figtree(fontSize: 12, color: _textMuted)),
                const SizedBox(height: 24),
                SizedBox(
                  height: 150,
                  child: LineChart(
                      ...
                      titlesData: FlTitlesData(
                        ...
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (value, meta) {
                              ...
                              Widget text;
                              switch (value.toInt()) {
                                case 0: text = const Text('May 10', style: style); break;
                                case 1: text = const Text('May 11', style: style); break;
                                case 2: text = const Text('May 12', style: style); break;
                                case 3: text = const Text('May 13', style: style); break;
                                case 4: text = const Text('May 14', style: style); break;
                                case 5: text = const Text('May 15', style: style); break;
                                case 6: text = const Text('May 16', style: style); break;
                        ...
                        leftTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            interval: 1,
                            getTitlesWidget: (value, meta) {
                              return Text('${value.toInt()}L', style: const TextStyle(color: _textMuted, fontSize: 10));
                            },
                            reservedSize: 28,
                          ),
                        ),
                      ...
                      titlesData: FlTitlesData(
                        ...
                        leftTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            reservedSize: 28,
                            interval: 2,
                            getTitlesWidget: (value, meta) => Text('${value.toInt()}L', style: const TextStyle(color: _textMuted, fontSize: 10)),
                          ),
                        ),
                        topTitles: const AxisTitles(sideTitles: SideTitles(showTitles: false)),
                        rightTitles: const AxisTitles(sideTitles: SideTitles(showTitles: false)),
                  ...
                  children: [
                      ...
                      child: SizedBox(
                        ...
                        child: PieChart(
                          PieChartData(
                            ...
                            sections: [
                              PieChartSectionData(color: const Color(0xFF6366F1), value: 61, title: '', radius: 25),
                              PieChartSectionData(color: const Color(0xFF3B82F6), value: 16, title: '', radius: 25),
                              PieChartSectionData(color: const Color(0xFF10B981), value: 12, title: '', radius: 25),
                              PieChartSectionData(color: const Color(0xFFF59E0B), value: 7, title: '', radius: 25),
                              PieChartSectionData(color: const Color(0xFF6B7280), value: 4, title: '', radius: 25),
                            ],
                          ),
                        ),
                      ),
                    ...
                    Expanded(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          _buildDonutLegendItem('Tuition', '61%', const Color(0xFF6366F1)),
                          _buildDonutLegendItem('Transport', '16%', const Color(0xFF3B82F6)),
                          _buildDonutLegendItem('Hostel', '12%', const Color(0xFF10B981)),
                          _buildDonutLegendItem('Exam', '7%', const Color(0xFFF59E0B)),
                          _buildDonutLegendItem('Other', '4%', const Color(0xFF6B7280)),
                        ],
                      ),
                    ),
                  ],
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(label, style: GoogleFonts.figtree(fontSize: 12, color: _textDark, fontWeight: FontWeight.w600)),
            ],
          ),
          Text(percent, style: GoogleFonts.figtree(fontSize: 12, color: _textMuted)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildManageListItem(LucideIcons.users, 'Student List', 'View all students'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildManageListItem(LucideIcons.layers, 'Class Wise Dues', 'Dues summary by class'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildManageListItem(LucideIcons.fileText, 'Student Fee Ledger', 'Individual fee transactions'),
          const Divider(height: 1, color: Color(0xFFE5E7EB)),
          _buildManageListItem(LucideIcons.award, 'Concession List', 'Scholarships & concessions'),
          const SizedBox(height: 8),
        ],
      ),
    );

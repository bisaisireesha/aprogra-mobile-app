  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Administration, support services, transport,\nsecurity and housekeeping personnel.',
          style: GoogleFonts.figtree(
            fontSize: 13,
            color: _textMuted,
            height: 1.4,
